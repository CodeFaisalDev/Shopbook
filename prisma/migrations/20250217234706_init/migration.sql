/*
  ...
  - A unique constraint covering the columns `[primaryEmailAddress]` on the table `User` will be added. If there are existing duplicate values, this will fail.
...
ADD COLUMN     "primaryEmailAddress" TEXT,
